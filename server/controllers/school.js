...
exports.createSchool = asyncHandler(async (req, res, next) => {
    ...
    if(createdSchool){
        ...
        res.status(500);
        throw new Error("Could not create new school at this time, please try again later");
    }
});
...
exports.updateSchool = asyncHandler (async (req, res, next) => {
    ...
    if(createdSchool){
        ...
        res.status(500);
        throw new Error("Could not update school at this time, please try again later");
    }   
});